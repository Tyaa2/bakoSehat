            ...
            <div class="relative px-6 max-w-8xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 ">
                        ...
                        <div class="relative flex flex-col w-full h-full bg-white rounded-xl bg-clip-border">
                        ...
                        <span class="inline-flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 7V3m8 4V3M5 11h14M5 19h14M3 7h18a2 2 0 012 2v11a2 2 0 01-2 2H3a2 2 0 01-2-2V9a2 2 0 012-2z"/>
                            </svg>
                            Tanggal Mulai
                        </span>
                    </label>
                                    ...
                                    <div class="block z-0 w-full overflow-hidden md:w-max">
                                        <nav>
                                            <ul role="tablist"
                                                ...
                                                <li role="tab">
                                                    <a href="{{ route('kelurahan.data-warga.index', ['filter' => 'all']) }}"
                                        ...
                                        @if ($filter === 'all') text-gray-900 bg-white shadow @else text-white @endif">
                                                ...
                                                <li role="tab">
                                                    <a href="{{ route('kelurahan.data-warga.index', ['filter' => 'approved']) }}"
                                                        class="relative flex items-center justify-center w-full h-full px-2 py-1 font-sans text-base antialiased font-normal leading-relaxed text-center cursor-pointer select-none rounded-md
                                        @if ($filter === 'approved') text-gray-900 bg-white shadow @else text-white @endif">
                                                ...
                                                <li role="tab">
                                                    <a href="{{ route('kelurahan.data-warga.index', ['filter' => 'rejected']) }}"
                                                        class="relative flex items-center justify-center w-full h-full px-2 py-1 font-sans text-base antialiased font-normal leading-relaxed text-center cursor-pointer select-none rounded-md
                                        @if ($filter === 'rejected') text-gray-900 bg-white shadow @else text-white @endif">
                                                ...
                                                <li role="tab">
                                                    <a href="{{ route('kelurahan.data-warga.index', ['filter' => 'pending']) }}"
                                                        class="relative flex items-center justify-center w-full h-full px-2 py-1 font-sans text-base antialiased font-normal leading-relaxed text-center cursor-pointer select-none rounded-md
                                        @if ($filter === 'pending') text-gray-900 bg-white shadow @else text-white @endif">
                                            ...
                                            <p class="mt-2 text-xs text-gray-600">
                                                ...
                                                - <strong>Diterima</strong>: Menampilkan data dengan surat domisili
                                                diterima (tidak ada alasan penolakan).<br>
                                                - <strong>Ditolak</strong>: Menampilkan data yang ditolak dengan alasan
                                                penolakan.
                                            </p>
                                        </nav>
                                    </div>
                                    <form method="GET" action="{{ route('kelurahan.data-warga.index') }}"
                                    ...
                                    <thead>
                                        <tr>
                                            <th
                                                ...
                                                <a href="{{ route('kelurahan.data-warga.index', [
                                                    'sort' => 'updated_at',
                                            ...
                                            <th
                                                class="sticky right-0 z-0 p-4 transition-colors cursor-pointer border-y border-gray-100 bg-indigo-50">
                                                <p
                                                    class="flex items-center justify-between gap-2 text-sm font-semibold text-gray-600 group">
                                                    Aksi
                                            ...
                                            <tr>
                                                ...
                                                <td class="p-4 border-b border-gray-50">
                                                    <div class="w-max">
                                                        ...
                                                        @else
                                                            <!-- Jika belum diproses dan belum ditolak -->
                                                            <div
                                                ...
                                                <td
                                                        ...
                                                        <div class="modal-box">
                                                            ...
                                                            <div class="step space-y-4" data-step="1">
                                                                ...
                                                                <div class="mt-6 flex justify-between items-center">
                                                                    ...
                                                                    <div class="flex gap-2">
                                                                        @if (is_null($warga->surat_keterangan_domisili))
                                                                            <!-- Tombol Tolak -->
                                                                            <button type="button"
                                                                                onclick="showTolakModal({{ $warga->id }})"
                                                                                class="flex items-center gap-1 text-white bg-red-600 hover:bg-red-700 px-4 py-2 rounded-md transition">
                                                                                Tolak
                                                                            ...
                                                                            <!-- Tombol Terima -->
                                                                            <button type="button"
                                                                                onclick="goToStep({{ $warga->id }}, 2)"
                                                                                class="flex items-center gap-1 text-white bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-md transition">
                                                                                Terima
                                                            ...
                                                            <div class="step hidden" data-step="2">
                                                                ...
                                                                <div class="text-center">
                                                                    ...
                                                                    <p class="text-sm text-gray-500">Surat Keterangan
                                                                        Domisili
                                                                        Peserta Pendaftaran BPJS Gratis.</p>
                                                                </div>

                                                                <form method="POST"
                                                                    action="{{ route('kelurahan.data-warga.update', $warga->id) }}"
                                                                    ...
                                                                    @php
                                                                        $domisiliId =
                                                                            'surat_keterangan_domisili_' . $warga->id;
                                                                    @endphp

                                                                    <label for="{{ $domisiliId }}"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                Klik untuk unggah Surat Keterangan
                                                                                Domisili</p>
                                                                            <p class="text-xs text-blue-400">Format:
                                                                                JPG, PNG, JPEG, PDF</p>
                                                                        </div>
                                                                        <input type="file"
                                                                            ...
                                                                            class="hidden"
                                                                            onchange="previewFile(event, 'preview-container-{{ $warga->id }}', 'preview-img-{{ $warga->id }}', 'preview-pdf-{{ $warga->id }}')">
                                                                    </label>

                                                                    <!-- Preview Area -->
                                                                    <div id="preview-container-{{ $warga->id }}"
                                                                        class="mt-4 text-center hidden">
                                                                        <img id="preview-img-{{ $warga->id }}"
                                                                        ...
                                                                        <iframe id="preview-pdf-{{ $warga->id }}"
                                                                            src="#"
                                                    ...
                                                    <div id="modal-tolak-{{ $warga->id }}"
                                                        class="modal-container hidden">
                                                        <form method="POST"
                                                            action="{{ route('kelurahan.kelurahan.data-warga.tolak', $warga->id) }}"
                                                            class="modal-box">
                                                            @csrf
                                                            <div
                                                                class="absolute top-0 left-1/2 -translate-x-1/2 w-48 h-20 bg-gradient-to-b from-blue-400/60 to-transparent blur-2xl opacity-90 z-10">
                                                            ...
                                                            <div class="my-6">
                                                                <textarea name="alasan_penolakan_kelurahan" required placeholder="Masukkan alasan penolakan..."
                            ...
                            <div class="flex items-center justify-between p-4 border-t border-gray-50">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <a href="{{ $dataWarga->previousPageUrl() }}"
                                        class="rounded-lg border border-gray-600 py-2 px-4 text-xs font-bold uppercase text-gray-600 transition-all hover:opacity-75 focus:ring focus:ring-gray-300 active:opacity-85 {{ $dataWarga->onFirstPage() ? 'pointer-events-none opacity-50' : '' }}">
                                        Previous
                                    </a>

                                    {{-- Tombol Next --}}
                                    <a href="{{ $dataWarga->nextPageUrl() }}"
                                        class="rounded-lg border border-gray-600 py-2 px-4 text-xs font-bold uppercase text-gray-600 transition-all hover:opacity-75 focus:ring focus:ring-gray-300 active:opacity-85 {{ !$dataWarga->hasMorePages() ? 'pointer-events-none opacity-50' : '' }}">
                                        Next
                                    </a>
                                </div>
                            </div>
