<x-app-layout>
    ...
    <form action="{{ route('puskesmas.data-warga.update', $dataWarga->id) }}" method="POST"
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nik" class="form-control" value="{{ $dataWarga->nik }}" required readonly>
        </div>
        <div class="mb-3">
