...
<form action="{{ route('rsud.data-warga.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
...
<div class="mb-3">
            ...
            <input type="date" name="tanggal_masuk_pasien" class="form-control" value="{{ old('tanggal_masuk_pasien') }}">
        </div>

<div class="mb-3">
            <label class="form-label">Tanggal Keluar Pasien</label>
            <input type="date" name="tanggal_keluar_pasien" class="form-control" value="{{ old('tanggal_keluar_pasien') }}">
        </div>
...
{{-- puskesmas --}}
        <div class="mb-3">
            <label class="form-label">Nama RSUD</label>
