                                    ...
                                    <div class="block z-0 w-full overflow-hidden md:w-max">
                                        <nav>
                                            <ul role="tablist"
                                                ...
                                                <li role="tab">
                                                    <a href="{{ route('dukcapil.approve.index', ['filter' => 'all']) }}"
                                        ...
                                        @if ($filter === 'all') text-gray-900 bg-white shadow @else text-white @endif">
                                                ...
                                                <li role="tab">
                                                    <a href="{{ route('dukcapil.approve.index', ['filter' => 'approved']) }}"
                                                        class="relative flex items-center justify-center w-full h-full px-2 py-1 font-sans text-base antialiased font-normal leading-relaxed text-center cursor-pointer select-none rounded-md
                                        @if ($filter === 'approved') text-gray-900 bg-white shadow @else text-white @endif">
                                                ...
                                                <li role="tab">
                                                    <a href="{{ route('dukcapil.approve.index', ['filter' => 'rejected']) }}"
                                                        class="relative flex items-center justify-center w-full h-full px-2 py-1 font-sans text-base antialiased font-normal leading-relaxed text-center cursor-pointer select-none rounded-md
                                        @if ($filter === 'rejected') text-gray-900 bg-white shadow @else text-white @endif">
                                                ...
                                                <li role="tab">
                                                    <a href="{{ route('dukcapil.approve.index', ['filter' => 'pending']) }}"
                                                        class="relative flex items-center justify-center w-full h-full px-2 py-1 font-sans text-base antialiased font-normal leading-relaxed text-center cursor-pointer select-none rounded-md
                                        @if ($filter === 'pending') text-gray-900 bg-white shadow @else text-white @endif">
                                            ...
                                            <p class="mt-2 text-xs text-gray-600">
                                                ...
                                                telah
                                                disetujui oleh pihak <strong>dukcapil.</strong><br>
                                                - <strong>Ditolak</strong>: Menampilkan data yang ditolak dengan alasan
                                                penolakan. <br>
                                                - <strong>Belum Diproses</strong>: Menampilkan data yang belum di proses oleh
                                                pihak <strong>dukcapil.</strong>
                                            </p>
                                        </nav>
                                    </div>
                                    <form method="GET" action="{{ route('dukcapil.approve.index') }}"
                                                ...
                                                <td
                                                            ...
                                                            <div class="step space-y-4" data-step="1">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="flex-1 mt-4 md:mt-0">
                                                                                <p class="text-gray-500 mb-1">Tanggal
                                                                                    Lahir</p>
                                                                                <p class="font-medium">
                                                                                    {{ \Carbon\Carbon::parse($warga->updated_at)->format('d-m-Y') }}</p>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="mt-6 flex justify-between items-center">
                                                                    ...
                                                                    <div class="flex gap-2">
                                                                        <!-- Tombol approve -->
                                                                        @if ($warga->status_approve_dukcapil !== 'approved')
                                                                            <form
                                                                                action="{{ route('dukcapil.approve', $warga->id) }}"
                                                    ...
                                                    <div id="modal-tolak-{{ $warga->id }}"
                                                        ...
                                                        <form method="POST"
                                                            ...
                                                            <div class="my-6">
                                                                <textarea name="alasan_penolakan_dukcapil" required placeholder="Masukkan alasan penolakan..."
